...
const consumerAddress = "0xDc59057716677afE37755e8aA256c8d852D62f64"; // REPLACE this with your Functions consumer address
const subscriptionId = 37; // REPLACE this with your subscription ID

const makeRequestArbitrumSepolia = async () => {
...
makeRequestArbitrumSepolia().catch((e) => {
  console.error(e);
  process.exit(1);
});
